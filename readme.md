# YOLOv11 Cigarette Cup Mobile Detection System

## Body

YOLOv11 Cigarette Cup Phone Detection System Based on Deep Learning YOLOv11: A cigarette cup phone detection system (YOLOv11+YOLO dataset + UI interface + login and registration interfaces + Python project source code + model)

nc: 3 classes,
Name: ['smoke', 'drink', 'phone'],
Dataset quantity: training set 3157 images, validation set 350 images.
